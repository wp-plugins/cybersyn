...
<div class="wrap">
    ...
    <a href="http://www.cyberseo.net/partners/thebestspinner.php" target="_blank"><img class="alignleft" style="margin:6px;" src="<?php echo plugins_url('/images/tbs32.png', __FILE__);  ?>" /></a>
